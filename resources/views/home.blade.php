...
@section('content')
    <main class="container mx-auto md:w-3/5 mt-3">
        ...
        <h1 class="mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-4xl lg:text-6xl"><span
                class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">FEATURED EVENT</span>
        </h1>
        ...
        <div class="grid grid-cols-1">
            ...
            @forelse ($featureds as $featured)
                <div
                    class=" bg-white border-2 border-orange-500 shadow-md dark:bg-gray-800 dark:border-gray-700 p-1 hover:-translate-y-1 hover:scale-100  duration-300 hover:cursor-pointer   hover:shadow-2xl">
                    <a href="#">
        ...
        <br>
        <h3 class="font-extrabold text-2xl text-gray-700 pb-3"> UPCOMING</h3>
